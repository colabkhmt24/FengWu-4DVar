...
from utils.misc import dictToObj, get_rank, get_world_size
...
class ConfigBuilder:
    ...
    def __init__(self, **params):
        ...
        self.tbwriter = params.get("tbwriter")
    ...
    def get_model(self, model_params=None):
        ...
        if type(model_params) == dict:
            ...
            if model_type == "train":
                ...
                raise NotImplementedError(f"Invalid model train type: {model_type}.")
    ...
    def get_sampler(self, dataset, split="train"):
        ...
        sampler = DistributedSampler(
            dataset, rank=rank, shuffle=shuffle, num_replicas=num_gpus, seed=0
        )
    ...
    def get_dataloader(
        ...
        return DataLoader(
            dataset, batch_size=batch_size, sampler=sampler, **dataloader_params
        )
    ...
    def get_metrics(self, metrics_params=None):
        ...
        metrics_list = metrics_params.get(
            "types",
            [
                "MSE",
                "MaskedMSE",
    ...
    def get_inference_checkpoint_path(self, inference_params=None):
        ...
        return inference_params.get(
            "checkpoint_path", os.path.join("checkpoint", "checkpoint.tar")
        )
...
def get_lr_scheduler(
    optimizer, lr_scheduler_params=None, resume=False, resume_epoch=None
):
    """
